...
$("#btnGuardar").click(function () {
    ...
    modelo["idProducto"] = $("#txtId").val() ? parseInt($("#txtId").val()) : 0;
    ...
    //prueba de codigo nuevo 
    // Previsualizar la imagen
    //if (inputFoto.files && inputFoto.files[0]) {
    //    const imgUsuario = document.getElementById("imgUsuario");
    //    imgUsuario.src = URL.createObjectURL(inputFoto.files[0]);
    //}
    // hasta aca 
    ...
    //console.log("Datos a enviar:", modelo);//ver que datos envia 

    $("#modalData").find("div.modal-content").LoadingOverlay("show");
    //debugger; // Esto pausará la ejecución aquí
